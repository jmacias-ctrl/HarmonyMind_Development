...
Route::post('/users', [usersController::class, 'relation_store'])->name('relations-store')->middleware('auth');
...
Route::get('/categories/{id}', [categoryController::class, 'show'])->name('categories-edit')->middleware('auth');
Route::patch('/categories/{id}', [categoryController::class, 'update'])->name('categories-update')->middleware('auth');
...
Route::get('/events/create', [App\Http\Controllers\eventController::class, 'create'])->name('events-create')->middleware('auth');
Route::post('/events', [eventController::class, 'store'])->name('events-store')->middleware('auth');
Route::get('/events/{id}', [eventController::class, 'show'])->name('events-edit')->middleware('auth');
Route::patch('/events/{id}', [eventController::class, 'update'])->name('events-update')->middleware('auth');
